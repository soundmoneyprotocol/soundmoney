    ...
    return (
        <>
            <div className='lightPrivacyBg md:px-32 px-8 space-y-8 md:py-40 pt-48 bg-center bg-cover bg-fixed text-sm'>
                <h1 className="text-3xl font-bold text-teal-500">Privacy Policy</h1>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            ...
                            in this Agreement) refers to Trap Chain Inc., 1390 Market Street
                            Suite 200.
                        </p>
                        <p>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to Trapchain, accessible from{" "}
                            <a
                                href="https://360nft.io/"
                                rel="noreferrer"
                                target="_blank"
                            >
                                https://360nft.io/
                ...
                <ul>
                    <li>
                        ...
                        <a
                            href="https://360nft.io/privacypolicy"
                            rel="noreferrer"
                            target="_blank"
                        >
                            https://360nft.io/privacypolicy
                        </a>
                    </li>
                </ul>
                <p>
