    ...
    <div className='lg:pt-32 pt-2 md:px-12 px-6'>
      ...
      <div className='mt-8 grid md:grid-cols-3 gap-6 pb-8'>
        ...
        <a
          ...
          className='px-5 py-12 items-center col-span-1 group border rounded-xl shadow-lg max-w-96 flex justify-between md:hover:scale-105  duration-200 hover:shadow-2xl'
        >
          <h2 className='font-bold text-2xl group-hover:border-b-2 border-black duration-200'>Sound Money Api</h2>
          <img src="https://s2.svgbox.net/hero-outline.svg?ic=external-link&color=00ffaa" width="22" height="22" />
        </a>
      </div>
    </div>
      ...
      <section className='py-20 md:sectionClip bg-gray-50 md:px-12 px-6'>
        <h2 className='textGradient md:text-7xl text-4xl font-gilroy text-center font-bold leading-relaxed'>Empowering Artists</h2>
      ...
      <section className='py-32 bgCta md:px-12 px-6'>
        ...
        <h4 className='text-4xl mt-12 font-bold md:text-white text-cyan-400'>Express excitement for the future <br />
