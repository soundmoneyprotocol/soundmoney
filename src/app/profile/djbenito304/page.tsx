                ...
                <div className='px-8 flex-wrap flex gap-8 items-stretch h-full'>
                    <div className='pt-16'>
                        ...
                        <p className='text-sm lg:max-w-96 text-justify leading-tight pt-5'>
                            DJBenito304 Americano #based Colombiano Musica es mi vida y la playa y las chicas 🍑🤑🎧 ingenerio a Tarjeta Trap
                            <span>
                                <a target='_blank' rel='noreferrer' href="https://t.me/+XWSPAqYaFNg0Mzcx" className='text-cyan-600 hover:text-cyan-500'>
                                    https://t.me/+XWSPAqYaFNg0Mzcx
                                </a>
                            </span>
                        </p>
                        {/* <div className='mt-8'>
                            <button className='orangeToPink py-2 px-8 rounded-full' onClick={() => setOpenStream(!openStream)}>Start Stream</button>
                        </div> */}
