    ...
    return (
        <div className='px-4 md:px-12 py-20 mx-4 md:mx-12 rounded-3xl shadow-2xl bg-white space-y-12 '>
            ...
            <div className='flex flex-col justify-center items-center space-y-8'>
                <div className='bg-[#EFF3F5] max-w-5xl rounded-3xl w-full shadow-lg grid grid-cols-1 lg:grid-cols-2 p-4 md:p-8 gap-y-8'>
                    ...
                    <div className='bg-[linear-gradient(180deg,_rgba(175,179,181,0.6)_42.73%,_#FD7125_100%)] w-full col-span-1 flex justify-center rounded-3xl'>
                        <img className='w-[65%] md:w-full' src='/images/phone.svg' />
                    </div>
                </div>
                <div className='bg-white max-w-5xl rounded-3xl w-full shadow-lg grid grid-cols-1 lg:grid-cols-2 p-4 md:p-8 gap-y-8'>
