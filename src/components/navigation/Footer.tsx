  ...
  return (
    <footer className="grid grid-cols-1 md:grid-cols-2 py-10 px-4 md:px-20 bg-black min-h-[70vh]">
      <div className="col-span-1 flex flex-row md:flex-col items-center md:items-start justify-between md:border-r bobrder-[#CFD1D3]">
        <Link
          href="/"
          className="bg-white rounded-2xl w-16 h-16 items-center flex justify-center"
        >
          <img src="/images/ft-logo.svg" />
        </Link>
        <Link
          href=""
          onClick={() => {
          ...
          className="border border-white rounded-full w-24 h-24 flex justify-center items-center text-white "
        >
          <MoveUp />
        </Link>
      </div>
